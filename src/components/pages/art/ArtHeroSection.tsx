...
const ArtHeroSection: React.FC<ArtHeroSectionProps> = ({
  className = "",
}) => {
    ...
    <div className={`w-full relative ${className}`}>
      <div
        className={`w-full relative bg-cover bg-center bg-no-repeat overflow-hidden   
            3xl:bg-[url('/assets/art-page/hero-1920.png')] 3xl:h-[476px]
            lg:bg-[url('/assets/art-page/hero-1440.png')] lg:h-[479px]
            md:bg-[url('/assets/art-page/hero-834.png')] md:h-[414px]
            bg-[url('/assets/art-page/hero-402.png')] h-[411px]
        `}
      >
        <div className="container-custom w-full h-full text-white">
          <motion.div
            ...
            className="flex flex-col justify-end items-start h-full  
              pb-[44px] md:pb-[51px] lg:pb-[96px] 3xl:pb-[91px] 
              space-y-1"
          >
            <nav
            ...
            <h1 className="text-[40px] md:text-[48px] font-medium md:font-normal lg:text-[64px] lg:font-medium leading-[123%]">
              Art Collection
            </h1>

            <p className="text-[20px] md:text-[24px] leading-[150%] max-w-[450px] lg:max-w-[540px] 3xl:max-w-[568px] tracking-[-0.2]">
              Fueling culture alongside industry. Our curated art collection reflects the same precision, ambition, and vision that define Danske Gas.
            </p>
